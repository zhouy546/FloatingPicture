...
//public delegate void mFunc(NImage nImage);

public class IRect : MonoBehaviour {
    //public event mFunc OnCompleteEvent;
   ...
   public virtual   void  initialization()
    ...
    public void SetLocation(Vector3 pos, float time, LeanTweenType leanTweenType = LeanTweenType.notUsed, /*NImage nImage = null*/ Action OnMoveComplete = null) {
        if (MoveLTDescr != null)
        {
            CancelMovementTween();
        }
